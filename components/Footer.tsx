  ...
  return (
      <footer className="border-t border-border bg-background px-8 pb-8 pt-16 text-muted-foreground">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="md:col-span-1">
                  ...
                  <ul className="space-y-2 text-sm">
                      ...
                      <li><a href="/shipping" className="hover:text-orange-500 transition-colors">Shipping policy</a></li>
                      <li><a href="/refund-policy" className="hover:text-orange-500 transition-colors">Returns & refunds</a></li>
          ...
          <div className="mx-auto mt-12 flex max-w-6xl flex-col items-center justify-between gap-4 border-t border-border pt-8 text-sm sm:flex-row sm:gap-0">
              <p>&copy; {new Date().getFullYear()} Second Skin Mens Ware. All Rights Reserved.</p>
